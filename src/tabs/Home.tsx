...
export default function Home() {
  ...
  return (
    <div className="screen">
      <AppHeader kicker="Good morning" title="Matchday" />
      <div className="scroll">
        ...
        >
          ...
          >
            ...
            <span className="btn btn-primary" style={{ fontSize: 13, padding: "9px 15px" }}>
              Get ready
            </span>
          </motion.button>
    ...
    return (
      <div className="card" style={{ overflow: "hidden" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 14px 10px" }}>
          ...
          <span className="chip" style={{ padding: "5px 10px", fontSize: 10, letterSpacing: "0.08em" }}>
            REPLAY
          </span>
        </div>
        <motion.button
          ...
          style={{ display: "block", width: "100%", padding: "0 14px" }}
        >
